...
def random_vector(tamaño):
    ...
    if norma_v == 0:
        ...
        return lib.vectorPorEscalar(v, 1/norma_v) #v/norma_v -> Nota para nosotros, capaz es mejor usar "/" de python que es mas rapido
...
def diagRH(A,tol=1e-15,K=1000):
    ...
    M = Hv1@A@ np.transpose(Hv1)#lib.producto_mat(
